...
function create_app(name, apps_folder, consolegl_folder)

	local consolegl_source_folder = path.join(consolegl_folder, "Source")
	local consolegl_dependencies_folder = path.join(consolegl_folder, "Dependencies")
	local consolegl_resources_folder = path.join(consolegl_folder, "Resources")
	...
	local PATH_CONSOLEGL_RESOURCES = string.format("PATH_CONSOLEGL_RESOURCES=\"%s\"", consolegl_resources_folder)
